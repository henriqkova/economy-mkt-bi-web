...
(function () {
  ...
  var PAGE_LABELS = {
    ...
    crm: '16 CRM',
    marketing_roi: '17 Custo por Lead',
    orcamento: '18 Orçamento',
    dre: '19 DRE',
  };
  function App() {
    var p = useState('marketing_roi'); var page = p[0], setPage = p[1];
    ...
    var PAGE_COMPS = {
      ...
      crm: PageCRM,
      marketing_roi: PageMarketingROI,
